      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-xs text-slate-500 font-medium">
            Live database records from the <code className="bg-slate-100 px-1.5 py-0.5 rounded text-sky-700 font-mono font-bold">professionals</code> table. Review, verify, and approve professional profiles.
          </p>
        </div>
        <Link
        ...
        >
          <UserPlus size={14} /> Professional Onboarding Portal
        </Link>
      </div>
