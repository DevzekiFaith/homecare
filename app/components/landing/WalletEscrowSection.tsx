...
const ESCROW_STEPS = [
  {
    ...
    desc: "The client selects their needed professional service, agrees on the transparent job quote, and submits the request on HomeCare.",
    metricValue: "100%",
  ...
  },
  {
    ...
    desc: "Customer deposits payment into HomeCare. Funds are protected and never sent directly to unverified professional bank accounts.",
    metricValue: "🔒 Safe",
  ...
  },
  {
    ...
    sub: "Professional Finishes",
    stepTitle: "Step 04: Professional Repair Execution",
    heading: "PROFESSIONAL COMPLETES JOB",
    desc: "The assigned NIN-verified professional arrives on-site, executes the repair work to specification, and submits final completion photos.",
    metricValue: "4.9★",
    metricLabel: "NIN Verified Work Quality",
    image: "/slide_plumbing_unique.jpg",
    badgeTitle: "Professional On-Site Work",
    badgeRole: "Verified Professional Repair",
    badges: [
  ...
  },
  {
    ...
    sub: "Pro Disbursed",
    stepTitle: "Step 06: Automatic Professional Disbursal",
    heading: "PAYMENT RELEASED TO PROFESSIONAL",
    desc: "Once confirmed, HomeCare automatically releases payment directly to the professional's wallet. Satisfaction guaranteed.",
    metricValue: "⚡ Instant",
    metricLabel: "Automated Professional Payout",
    image: "/slide_verified_pro.jpg",
    badgeTitle: "Disbursal Complete",
    badgeRole: "Professional Earns Earnings",
    badges: [
